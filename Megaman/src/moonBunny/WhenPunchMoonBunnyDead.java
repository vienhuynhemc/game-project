...
public class WhenPunchMoonBunnyDead extends EffortMapleStory {

	private Animation anime;

	public WhenPunchMoonBunnyDead(float x, float y, GameWorldMapleStory game) {
		super(x, y, game);

		anime = new Animation(getGame().getInputData().getListAnimation().get("mbeb"));
	}
