...
public abstract class HunmanMegamanX extends ParticulerObjectMegamanX {

	private boolean isJumping;
	private boolean isDicking;
	private boolean isLeoCauThang;

	public HunmanMegamanX(float x, float y, GameWorldMegamanX game, float mass, float width, float height, int blood,
			int dame) {
