...
public class Scratch extends BulletMapleStory {

	private long timeStart;

	public Scratch(float x, float y, GameWorldMapleStory game) {
		super(x, y, game, 0, 60, 60, 1000, 15);
	...
	public void upload() {
		...
		if (System.nanoTime() - timeStart > 500000000) {
			setStage(DEATH);
			setTrung(true);
		}
	}
	...
	public void getToDeath() {
		...
		getGame().getListEF().addEF(new BehurtScratchEffort(getX() - 40, getY() - 40, getGame()));
	}
