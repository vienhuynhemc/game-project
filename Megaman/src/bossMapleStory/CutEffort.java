...
public class CutEffort extends EffortMapleStory {

	private Animation anime;

	public CutEffort(float x, float y, GameWorldMapleStory game) {
		super(x, y, game);

		anime = new Animation(getGame().getInputData().getListAnimation().get("ira1r"));
		anime.setHeSo(1f);
	}
