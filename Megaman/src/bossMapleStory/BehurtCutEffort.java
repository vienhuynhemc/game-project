...
public class BehurtCutEffort extends EffortMapleStory {

	private Animation anime;

	public BehurtCutEffort(float x, float y, GameWorldMapleStory game) {
		super(x, y, game);

		anime = new Animation(getGame().getInputData().getListAnimation().get("iref1"));
	}
