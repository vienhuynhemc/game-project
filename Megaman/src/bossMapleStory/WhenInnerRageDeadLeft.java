...
public class WhenInnerRageDeadLeft extends EffortMapleStory {

	private Animation anime;

	public WhenInnerRageDeadLeft(float x, float y, GameWorldMapleStory game) {
		super(x, y, game);
	...
	public void draw(Graphics2D g2) {
		anime.draw(g2, (int) (getX() + 4 - getGame().getCamera().getX()),
