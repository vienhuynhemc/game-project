...
public class CommentMapleStory extends GameObjectMapleStory implements Upload {
	...
	public CommentMapleStory(float x, float y, GameWorldMapleStory game, int team, String comment) {
		super(x, y, game);
