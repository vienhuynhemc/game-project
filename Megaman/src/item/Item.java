...
public abstract class Item extends GameObjectMegamanX {
	...
	public Item(float x, float y, GameWorldMegamanX game, int width, int height, float mass, float speedY) {
		super(x, y, game);
		this.width = width;
		this.height = height;
		this.mass = mass;
		...
		setStage(ParticulerObjectMegamanX.ALIVE);
	...
	@Override
	public void upload() {
		if (getStage() == ParticulerObjectMegamanX.ALIVE) {
			if (System.currentTimeMillis() - timeStart > timeForAlive) {
				timeStart = System.currentTimeMillis();
				setStage(ParticulerObjectMegamanX.FEY);
			}
		} else if (getStage() == ParticulerObjectMegamanX.FEY) {
