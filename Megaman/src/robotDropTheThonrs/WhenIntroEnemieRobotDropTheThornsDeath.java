...
public class WhenIntroEnemieRobotDropTheThornsDeath extends WhenDeath {
	...
	public WhenIntroEnemieRobotDropTheThornsDeath(float x, float y, GameWorldMegamanX game) {
		super(x, y, game, 0.1f);
		...
		Rectangle rect1 = new Rectangle((int) x, (int) y, 110, 14);
		Rectangle rect2 = new Rectangle((int) x, (int) y, 40, 36);
		Rectangle rect3 = new Rectangle((int) x, (int) y, 18, 40);
		...
		animation1 = new Animation(getGame().getInputData().getListAnimation().get("canhQuatRobotThaQuaCauGai"));
		animation2 = new Animation(getGame().getInputData().getListAnimation().get("whenRobotThaQuaCauGaiDeath1"));
		animation3 = new Animation(getGame().getInputData().getListAnimation().get("whenRobotThaQuaCauGaiDeath2"));
